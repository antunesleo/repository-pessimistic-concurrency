...
class TestORMQuestionRepository(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        some_engine = create_engine('sqlite:////home/antunesleo/projects/parallel-aggregates/aggregate_classic_repository/aggregate-classic-repository.db')
    ...
    def test_should_add_new_question(self):
        ...
        questions = self.__orm_question_repository.get_all()
